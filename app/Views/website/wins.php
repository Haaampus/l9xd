...
<head>
	...
	<title>Net Wins Boost — L9 Boosting</title>
</head>
<body>
		...
		<div class="layer">
			<div class="container">
				...
				<div class="header-content">
					<h1 class="header-page-title">net wins boost</h1>
				</div>
			</div>
		</div>
	</header><!-- /header -->
		    ...
		    $.ajax({
		      ...
		      success: function (data) {
		          if(data == 0)
		          {
		            ...
		            document.getElementById("submit_order").href='<?php echo App\Router\Router::url('paypal_payment'); ?>?custom=Net Wins|' + queue + '|' + duo + '|' + data + '|EUR|' + server + '|' + current_rank + '|' + current_rank_division + '|0-20|' + '|' + '|' + wins;
		          }
		        }
		    });
		}
